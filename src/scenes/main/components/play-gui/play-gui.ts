...
export class PlayGui extends Container {
  ...
  private readonly buttons: SpriteButton[] = [];
  ...
  constructor(options: MainScreenGuiProps) {
    ...
    toActionArea(buyBonusButton.view, { x: 470, y: bottomRowY });
    this.buttons.push(buyBonusButton);
    this.addChild(buyBonusButton.view);
  ...
  public hideFreeSpinsField() {
    this.freeSpinsField.visible = false;
  }

  public showFreeSpinsField() {
    this.freeSpinsField.visible = true;
  }
